	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				@can('view-products')
				<li class="submenu">
					<a href="#"><i class="fe fe-document"></i> <span> Products</span> <span class="fe fe-menu-arrow"></span></a>
				...
				@can('view-purchase')
				<li class="submenu">
					<a href="#"><i class="fe fe-star-o"></i> <span> Purchase</span> <span class="fe fe-menu-arrow"></span></a>
					<ul style="display: none;">
				...
				@can('view-sales')
				<li class="submenu">
					<a href="#"><i class="fe fe-activity"></i> <span> Sale</span> <span class="fe fe-menu-arrow"></span></a>
					<ul style="display: none;">
				...
				@can('view-supplier')
				<li class="submenu">
					<a href="#"><i class="fa fa-user"></i> <span> Supplier</span> <span class="fe fe-menu-arrow"></span></a>
					<ul style="display: none;">
				...
				@can('view-reports')
				<li class="submenu">
					<a href="#"><i class="fe fe-document"></i> <span> Reports</span> <span class="fe fe-menu-arrow"></span></a>
					<ul style="display: none;">
				...
				<li class="submenu">
					<a href="#"><i class="fe fe-lock"></i> <span> Access Control</span> <span class="fe fe-menu-arrow"></span></a>
					<ul style="display: none;">
						@can('view-permission')
